...
export default function Payment() {
	...
	const {
		...
		defaultValues: {
			fullName: 'Antônio Soprano',
			email: 'toni_sopranos@email.com',
			mobile: '6889556644',
			document: '15367033385',
			zipCode: '40260190',
			street: '1ª Travessa Alto do Coqueiro',
			number: '708',
			complement: '',
			neighborhood: 'Matatau',
			city: 'Salvador',
			state: 'BA',
			creditCardNumber: '5206 1710 4625 6285',
			creditCardHolder: 'Antônio Soprano',
			creditCardExpiration: '0125',
			creditCardSecurityCode: '316',
		},
	});

	const onSubmit: SubmitHandler<FieldValues> = (data) => payOrder(data as FieldValues);
